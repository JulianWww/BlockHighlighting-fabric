...
public class Config implements IConfigHandler {
	...
	public static class Generic {
		public static final ConfigBoolean 	SHOULD_RENDER 	= new ConfigBoolean("should render", 	true, "Should Render Highlights", "Should Render Highlights");
		public static final ConfigInteger	RENDER_RANGE	= new ConfigInteger("render range",		1, 0, 10, "how many chunks range the highlighter should render");

		public static final ImmutableList<IConfigBase> OPTIONS = ImmutableList.of(
				Generic.SHOULD_RENDER,
				Generic.RENDER_RANGE
				);
	}
