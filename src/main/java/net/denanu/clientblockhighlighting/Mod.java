...
import net.denanu.clientblockhighlighting.command.BlockHighlightCommands;
...
public class Mod implements ModInitializer {
	...
	public void onInitialize() {
		HighlighterTypes.setup();
		CommandRegistrationCallback.EVENT.register(BlockHighlightCommands::register);
	}
}
